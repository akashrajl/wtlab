<%@page import="com.akash.AirlineServiceInterface"%>
...
<body>
    ...
    <%
        ...
        // Web Service URL
        URL url = new URL("http://localhost:8080/akash2/AirlineServiceService?WSDL");

        // Define QName for the service
        QName qname = new QName("http://akash.com/", "AirlineServiceService");
