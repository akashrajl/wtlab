...
<%@ page import="com.cc.CCI" %> <!-- Import the web service interface -->
    ...
    <div class="form-container">
        ...
        if (fromCurrency != null && toCurrency != null && amountStr != null) {
            try {
                ...
                URL url = new URL("http://localhost:8080/CC/CC1Service?WSDL");
                QName qname = new QName("http://cc.com/", "CC1Service");
